...
public class APIworkFlowSteps {
    ...
    public void a_request_is_prepared_for_creating_an_employee() {
        request = given().header(APIConstants.Header_Content_Type, APIConstants.Content_Type).
                header(APIConstants.Header_Authorization, GenerateTokenSteps.token).body(APIpayloadBodyConstants.createEmployeePayload());
    ...
    public void a_request_is_prepared_for_creating_an_employee_with_dynamic_data(String emp_firstname, String emp_lastname,
        ...
        request = given().header(APIConstants.Header_Content_Type, APIConstants.Content_Type).
                header(APIConstants.Header_Authorization, GenerateTokenSteps.token).body(APIpayloadBodyConstants.payloadMoreDynamic
